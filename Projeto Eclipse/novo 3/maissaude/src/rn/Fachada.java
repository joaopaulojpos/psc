...
public class Fachada {
	...
	public Doenca pesquisarDoencaPorCND(String cnd){
		return rnDoenca.pesquisarDoencaCND(cnd);
	}
	
	public Doenca pesquisarDoencaPorNome(String nome){
		return rnDoenca.pesquisarDoencaNome(nome);
	}
	
	public void removerDoenca(Doenca doenca) throws ValidacaoException{
